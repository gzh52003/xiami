...
class Details extends React.PureComponent {
    ...
    async componentDidMount() {
        ...
        const res1 = await request.get(`/top/album?offset=${num}&limit=3`);
        this.setState({
            data1: res1.albums
        });
        ...
        return (
            <div style={{width:"100%",background:"#fff"}}>
                <div className='menu-active'>
                    ...
                    >{this.state.tag?this.state.tag:'虾米音乐'}</NavBar>
                </div>
                <div style={{ width: "90%", textAlign: "left", margin: "0 auto"}}>
                    ...
                    <div>
                        <h2 style={{ float: "left", width: "80%", fontWeight: "400", marginLeft:"4px" }}>相关艺人</h2>
                        <h4 style={{ float: "left", fontWeight: "300" , marginTop: "30px" }} >更多</h4>
                        <Icon type="right" style={{ marginTop: "28px" }}></Icon>
                    </div>
                    <div style={{ height: "300px",width:"90%", margin:"0 auto" }}>
                        {
                            data3.map(item =>
                                <div
                                    key={item.id}
                                    style={{ float: "left", width: "30%", marginRight: "10px", textAlign: "center", overflow: "hidden" }}
                                >
